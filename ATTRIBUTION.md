# Team attribution and publication changes

OceanSense was developed by Brunel group A21, Start-up 1, in 2025/26.

| Contributor | Main area |
| --- | --- |
| Joan Mancilla Cetre | Authentication and account/vessel management; integration and sprint coordination |
| Shahir | Electronic logbook, catch/bycatch forms, trip management and database mapping |
| Noman | Mapping, geofencing, zone editor, mobile integration and cross-module architecture |
| Lloyd | Fleet dashboard, quota interface and analytics visualisation |
